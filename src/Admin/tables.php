            ...
            <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
              <form action="#" class="main-navbar__search w-100 d-none d-md-flex d-lg-flex">
                <div class="input-group input-group-seamless ml-3">
                  ...
                  <input class="navbar-search form-control" type="text" placeholder="Tìm kiếm gì đó .. " aria-label="Search"> </div>
              </form>
              <ul class="navbar-nav border-left flex-row ">
                    ...
                    <a class="dropdown-item" href="#">
                      ...
                      <div class="notification__content">
                        ...
                        <p>Website của bạn có số tài khoản người sử dụng tăng
                          <span class="text-success text-semibold">28%</span> trong tuần trước.Tuyệt vời!</p>
                      </div>
                    </a>
                    <a class="dropdown-item" href="#">
                      <div class="notification__icon-wrapper">
                      ...
                      <div class="notification__content">
                        <span class="notification__category">Tương tác</span>
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img class="user-avatar rounded-circle mr-2" src="../../public/images/picture%20home%20login/icons8-google-home-64.png" alt="User Avatar">
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">D.I.Y</span>
              ...
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Người dùng đang hoạt động</h6>
                  </div>
                    ...
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          ...
                          <th scope="col" class="border-0">Tên đăng nhập</th>
                          <th scope="col" class="border-0">Tên người sử dụng</th>
                          <th scope="col" class="border-0">Mật khẩu</th>
                          <th scope="col" class="border-0">Số bài đăng</th>
                          <th scope="col" class="border-0">Điểm tương tác</th>
                        </tr>
                      </thead>
                      <tbody>
                      <?php
